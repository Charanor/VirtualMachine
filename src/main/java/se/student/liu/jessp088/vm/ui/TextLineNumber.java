 ...
 * TextLineNumber supports wrapped lines and will highlight the line
 * number of the current line in the text component.
 * <p>
 * This class was designed to be used as a component added to the row
 * header of a JScrollPane.
 */
public class TextLineNumber extends JPanel implements CaretListener, DocumentListener, PropertyChangeListener
{
    ...
    // Text component this TextTextLineNumber component is in sync
    // with
    ...
    // Keep history information to reduce the number of times the
    // component
    ...
    /**
     * Create a line number component for a text component. This
     * minimum display width will be based on 3 digits.
     *
     ...
     *
     * @param component            the related text component
     * @param minimumDisplayDigits the number of digits used to calculate the minimum
    ...
    /**
     * Set the update font property. Indicates whether this Font
     * should be updated automatically when the Font of the related
     * text component is changed.
     *
    ...
    /**
     * The border gap is used in calculating the left and right
     * insets of the border. Default value is 5.
     *
     ...
     * </ul>
     *
     * @param digitAlignment the alignment
     */
    ...
    /**
     * Specify the mimimum number of digits used to calculate the
     * preferred width of the component. Default is 3.
     *
    ...
    /**
     * Calculate the width needed to display the maximum line
     * number
     */
	...
	// Update sizes when number of digits in the line number
	// changes
    ...
    /* We need to know if the caret is currently positioned on the
     * line we are about to paint so the line number can be
     * highlighted. */
    ...
    /* Get the line number to be drawn. The empty string will be
     * returned when a line of text has wrapped. */
    ...
    /* Determine the X offset to properly align the line number when
     * drawn */
	...
	// The text needs to be positioned above the bottom of the
	// bounding
	// rectangle based on the descent of the font(s) contained on
	// the row.
    ...
    /* A document change may affect the number of displayed lines of
     * text. Therefore the lines numbers will also change. */
