...
{
	@Override
	public Instruction getInstruction(final VMInstruction instruction, final int... inputArgs) throws IllegalArgumentException {
		...
		for (int i = 0; i < args.length; i++) { args[i] = inputArgs[i]; }
